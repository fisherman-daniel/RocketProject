...
#define MAVLINK_MSG_ID_HEARTBEAT_CRC 215
#define MAVLINK_MSG_ID_0_CRC 215
...
#define MAVLINK_MESSAGE_INFO_HEARTBEAT { \
    ...
    "HEARTBEAT", \
    1, \
    {  { "nothin", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_heartbeat_t, nothin) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HEARTBEAT { \
                               ...
                               uint8_t nothin)
{
    ...
    _mav_put_uint8_t(buf, 0, nothin);

        memcpy(_MAV_PAYLOAD_NON_CONST(msg), buf, MAVLINK_MSG_ID_HEARTBEAT_LEN);
#else
    mavlink_heartbeat_t packet;
    packet.nothin = nothin;
...
{
    return mavlink_msg_heartbeat_pack(system_id, component_id, msg, heartbeat->nothin);
}
...
{
    return mavlink_msg_heartbeat_pack_chan(system_id, component_id, chan, msg, heartbeat->nothin);
}
...
static inline void mavlink_msg_heartbeat_send(mavlink_channel_t chan, uint8_t nothin)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_HEARTBEAT_LEN];
    _mav_put_uint8_t(buf, 0, nothin);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_heartbeat_send(chan, heartbeat->nothin);
#else
 ...
 */
static inline void mavlink_msg_heartbeat_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t nothin)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field nothin from heartbeat message
 *
 * @return  
 */
static inline uint8_t mavlink_msg_heartbeat_get_nothin(const mavlink_message_t* msg)
{
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    heartbeat->nothin = mavlink_msg_heartbeat_get_nothin(msg);
#else
